...

{
	...
	obs_property_list_add_string(p_model_select, obs_module_text("CorridorKey FP16 512 (precompiled)"), MODEL_CORRIDORKEY_FP16_512_CTX);
	obs_property_list_add_string(p_model_select, obs_module_text("CorridorKey FP16 1024 (precompiled)"), MODEL_CORRIDORKEY_FP16_1024_CTX);
